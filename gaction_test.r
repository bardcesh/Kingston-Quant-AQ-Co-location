...
serial_number = 'MOD-PM-00037' # Specific to this monitoring device
...
wk <- read_csv("https://raw.githubusercontent.com/bardcesh/Kingston-Quant-AQ-Co-location/main/data/datetime_lister.csv", col_types = "cddc") 
